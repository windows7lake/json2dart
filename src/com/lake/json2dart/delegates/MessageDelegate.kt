...
class MessageDelegate {
    ...
    private val logGroup = NotificationGroup(GROUP_LOG, NotificationDisplayType.NONE, true)

    fun onException(throwable: Throwable) {
        val message = throwable.message ?: "Something went wrong"
        sendNotification(logGroup.createNotification(message, NotificationType.INFORMATION))
